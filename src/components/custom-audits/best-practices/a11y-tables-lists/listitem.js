...
export const ListItem = ({ lighthouse }) =>
  lighthouse.audits.listitem.score !== 1 &&
  lighthouse.audits.listitem.score !== null && (
    <li id="list">
      <dl>
        <dt>
          ...
          <span
            className={`${
              lighthouse.audits.listitem.score < 0.5
                ? `bg-red-300 text-red-900`
                : `bg-orange-300 text-orange-900`
            } font-black inline-block ml-2 px-2 rounded-full text-sm`}
          >
            {lighthouse.audits.listitem.displayValue}
          </span>
        </dt>
        <dd>
          <details>
            ...
            <div className="mt-4">
              {lighthouse.stackPacks[0].descriptions.listitem && (
                <Markdown>
                  {lighthouse.stackPacks[0].descriptions.listitem}
                </Markdown>
              )}
