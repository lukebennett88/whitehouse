...
export const AudioCaption = ({ lighthouse }) =>
  lighthouse.audits['audio-caption'].score !== 1 &&
  lighthouse.audits['audio-caption'].score !== null && (
    <li id="audio-caption">
      <dl>
        <dt>
          <Markdown>{lighthouse.audits['audio-caption'].title}</Markdown>
          <span
            className={`${
              lighthouse.audits['audio-caption'].score < 0.5
                ? `bg-red-300 text-red-900`
                : `bg-orange-300 text-orange-900`
            } font-black inline-block ml-2 px-2 rounded-full text-sm whitespace-no-wrap`}
          >
            {lighthouse.audits['audio-caption'].displayValue}
          </span>
        </dt>
        <dd>
          <details open>
            <summary>
              <Markdown>
                {lighthouse.audits['audio-caption'].description}
              </Markdown>
            </summary>
            <div className="mt-4">
